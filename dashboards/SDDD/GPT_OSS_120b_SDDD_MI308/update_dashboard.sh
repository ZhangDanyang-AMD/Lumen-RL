...
container = "gpt_oss_120b_eagle3_mi350"
...
# Also read from log file on disk
log_file = "/home/danyzhan/Lumen-RL/output/GPT_OSS_120b_SDDD/LumenRL/gpt-oss-120b-eagle3-mi350.log"
...
<title>GPT-OSS-120B Eagle3 SDDD - MI350 ATOM</title>
...
<div class="header">
<h1>GPT-OSS-120B Eagle3 SDDD - MI350 ATOM</h1>
<p class="sub">UltraChat+Magpie 508K | lr=1e-4 | bs=32 | spec_length=3 | 8x MI350 (Lumen FSDP2 + ATOM BF16)</p>
