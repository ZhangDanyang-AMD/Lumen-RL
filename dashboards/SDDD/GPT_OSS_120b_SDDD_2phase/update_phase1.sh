#!/bin/bash
# Update phase1.html dashboard for GPT-OSS-120B Eagle3 SDDD v3 two-phase training.
set -euo pipefail
python3 << 'PYEOF'
import sys, re, json, os, subprocess
from datetime import datetime

container = "gpt_oss_120b_eagle3_v3_phase1_mi355"
dir_path = "/home/danyzhan/Lumen-RL/dashboards/SDDD/GPT_OSS_120b_SDDD_2phase"
...
# Read from LumenRL output log
lumenrl_log = "/home/danyzhan/Lumen-RL/output/GPT_OSS_120b_SDDD_v3/LumenRL/gpt-oss-120b-eagle3-v3-phase1-mi355.log"
eval_raw = ""
...
if container_running:
    try:
        ...
        tmp = os.path.join(dir_path, ".step_logs_v3.tmp")
        if log_exists:
...
status = "Training" if container_running else ("Completed" if cur>=total_steps-500 else "Stopped")
...
<title>GPT-OSS-120B Eagle3 SDDD v3 - Phase 1</title>
...
<div class="header">
<h1>GPT-OSS-120B Eagle3 SDDD v3 - Phase 1 (Short Context)</h1>
<p class="sub">On-Policy | Nemotron PTv3 ~2.7M prompts (≤4096 tok) | lr=1e-4 | bs=32 | forward_kl | spec_length=3 | 8x MI355 | Resume from v1 step 15800</p>
