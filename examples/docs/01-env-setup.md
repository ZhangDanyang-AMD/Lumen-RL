...
# ATOM (examples 4, 5) is pinned to a commit on upstream ROCm/ATOM main; see
# chapter 8 §8.1.1. Take it by SHA rather than by branch, so that main moving on
# does not silently change what you built:
