...
Aligned with lightseekorg/kimi-mtp-dataset format used by both Kimi-K2.5
and Kimi-K3 DSpark training. Phase 1 uses perfectblend samples for
foundation training; Phase 2 uses mixed-domain samples for diversity.
"""
import json
import os
